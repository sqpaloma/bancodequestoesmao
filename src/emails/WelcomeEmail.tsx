        ...
        <Container style={container}>
          <Section style={content}>
            ...
            <Text style={text}>
              ...
              You&apos;ve taken the first step towards mastering modern
              development skills through engaging, project-based learning.
            </Text>
            <Hr style={hr} />
            ...
            <Hr style={hr} />
            <Text style={text}>
              Ready to start forging your path in modern development? Explore
              our course catalog and begin your learning journey today!
            </Text>
          ...
          <Section style={footer}>
            <Text style={footerText}>
              © {new Date().getFullYear()} MasterClass, Inc. All Rights
              Reserved.
            </Text>
          </Section>
        </Container>
