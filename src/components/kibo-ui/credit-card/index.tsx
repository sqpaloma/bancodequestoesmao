...
// Wrapper component for PaymentIcon
const PaymentIcon = (props: ComponentProps<typeof OriginalPaymentIcon>) => {
  useEffect(() => {
    suppressClipPathWarning();
  }, []);

  return <OriginalPaymentIcon {...props} />;
};
